sap.ui.define(["sap/ui/core/mvc/Controller",
	"sap/m/MessageBox",
	"./ActionSheet17", "./ActionSheet16", "./ActionSheet15",
	"./utilities",
	"sap/ui/core/routing/History"
], function(BaseController, MessageBox, ActionSheet17, ActionSheet16, ActionSheet15, Utilities, History) {
	"use strict";

	return BaseController.extend("com.sap.build.standard.sistemaDeArchivos.controller.Page19", {
		...
		_onIconPress1: function(oEvent) {
			...
			var sActionsheetName = "ActionSheet16";
			this.mActionsheets = this.mActionsheets || {};
			var oActionsheet = this.mActionsheets[sActionsheetName];

			if (!oActionsheet) {
				oActionsheet = new ActionSheet16(this.getView());
				this.mActionsheets[sActionsheetName] = oActionsheet;
		...
		_onButtonPress: function(oEvent) {
			...
			var sActionsheetName = "ActionSheet17";
			this.mActionsheets = this.mActionsheets || {};
			var oActionsheet = this.mActionsheets[sActionsheetName];

			if (!oActionsheet) {
				oActionsheet = new ActionSheet17(this.getView());
				this.mActionsheets[sActionsheetName] = oActionsheet;
