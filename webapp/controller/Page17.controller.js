sap.ui.define(["sap/ui/core/mvc/Controller",
	"sap/m/MessageBox",
	"./ActionSheet11", "./ActionSheet10", "./ActionSheet9",
	"./utilities",
	"sap/ui/core/routing/History"
], function(BaseController, MessageBox, ActionSheet11, ActionSheet10, ActionSheet9, Utilities, History) {
	"use strict";

	return BaseController.extend("com.sap.build.standard.sistemaDeArchivos.controller.Page17", {
		...
		_onIconPress1: function(oEvent) {
			...
			var sActionsheetName = "ActionSheet10";
			this.mActionsheets = this.mActionsheets || {};
			var oActionsheet = this.mActionsheets[sActionsheetName];

			if (!oActionsheet) {
				oActionsheet = new ActionSheet10(this.getView());
				this.mActionsheets[sActionsheetName] = oActionsheet;
		...
		_onButtonPress: function(oEvent) {
			...
			var sActionsheetName = "ActionSheet11";
			this.mActionsheets = this.mActionsheets || {};
			var oActionsheet = this.mActionsheets[sActionsheetName];

			if (!oActionsheet) {
				oActionsheet = new ActionSheet11(this.getView());
				this.mActionsheets[sActionsheetName] = oActionsheet;
